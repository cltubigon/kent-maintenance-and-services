...
const Icon_leaf_clearance = forwardRef(function Icon_leaf_clearance(
  { className, ...props },
  ref
) {
  return (
...
export default Icon_leaf_clearance
