    ...
    <div className="py-10 md:py-[80px]">
        <div className={'container md:px-6 lg:px-10 xl:px-0'}>
          <div className={'text-center'}>
            ...
            <p className={'mt-5'}>
              Keeping your carpets clean requires more than just vacuuming
              alone. To get a deep clean, Xtraclean use the latest
              state-of-the-art equipment and solutions for the best results
              everytime.
            </p>
          </div>
          <div className={'grid grid-cols-1 md:grid-cols-3 gap-10 mt-16'}>
            <div className={'text-center'}>
              ...
              <p className={'mt-5'}>
                ...
                requirements. We can provide you with a live quote and schedule
                an appointment.
              </p>
            </div>
            <div className={'text-center'}>
              ...
              <p className={'mt-5'}>
                ...
                on the location of the carpets that require cleaning. Please
                give your technician specific instructions if necessary.
              </p>
            </div>
            <div className={'text-center'}>
              ...
              <p className={'mt-5'}>
                ...
                your floor covers are now deep cleaned and sanitised, good
                enough to eat off!
              </p>
            </div>
          </div>
