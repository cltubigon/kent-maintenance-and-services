...
import protect from './images/protect.2e16d0ba.fill-450x450.jpg'

const PcucSection1a = () => {
  return (
    <div className={'py-10 md:py-[80px] bg-primary-50'}>
      <div className={'container md:px-6 lg:px-10 xl:px-0'}>
        ...
        >
          <div
            className={
              'flex flex-col gap-5 md:gap-10 text-center bg-white p-5 md:p-10 rounded-md shadow-custom2'
            }
          >
